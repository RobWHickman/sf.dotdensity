...
Another good example using Bosnian ethnicity data (which is used in the package hex sticker) can be found [here](https://twitter.com/majda_ruge/status/1037704253043879936). For an extra example I decided to look at South African language diversity, which I'd previously seen good visualisation of [here](https://adrianfrith.com/linguistic-diversity/)

```{r bosnia_example, message=FALSE,warning=FALSE}
bosnia_sf_data <- merge(bosnia_shapefile, bosnia_ethnicity_data, by = "district")

ethnicities <- c("Bosniak", "Serb", "Croat", "Others")
bosnia_palette <- c("goldenrod", "mediumblue", "white", "grey")
...
```{r south_africa_example, message=FALSE,warning=FALSE}
